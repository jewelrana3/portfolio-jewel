...
const Servies = () => {
  return (
    <div className="mt-40 text-center mb-20" id="servies">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-7 md:px-20 mt-12 servies-div">
        <div className="servics-three-div text-left">
          <p className="servies-frontend text-center text-black text-xl">
          ...
          <div className="one-div">
            ...
            <div className="flex mt-4 items-center gap-6 text-white">
              ...
              <p>
                Understanding of HTML, CSS, and <br /> JavaScript
              </p>
            </div>
            <div className="flex mt-4 items-center gap-6 text-white">
              <p>
              ...
              <p>
                Experience with JavaScript frameworks <br /> React
              </p>
            </div>
            <div className="flex mt-4 items-center gap-6 text-white">
              <p>
              ...
              <p>
                Familiarity with browser developer <br /> tools
              </p>
            </div>
            <div className="flex mt-4 items-center gap-6 text-white">
              <p>
              ...
              <p>
                Understanding of responsive design <br /> principles
              </p>
            </div>
            <div className="flex mt-4 items-center gap-6 text-white">
              <p>
